...
class Test(unittest.TestCase):
    ...
    def compare_matrices(self, matrix: np.ndarray) -> NoReturn:
    ...
    def test_channel_from_matrix(self) -> NoReturn:
    ...
    def test_channel_from_svd(self) -> NoReturn:
    ...
    def test_compressor_bw(self) -> NoReturn:
    ...
    def test_compressor(self) -> NoReturn:
        compressor: Compressor = Compressor()
        self.assertIsNotNone(compressor, "compressor is None")
        self.assertIsInstance(compressor, Compressor, "compressor is not a Compressor")
